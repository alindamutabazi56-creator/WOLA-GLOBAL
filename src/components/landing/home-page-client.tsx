    ...
    <div id="top" className="min-h-screen bg-white text-[#241634]">
      ...
      <Section id="chapters" className="scroll-mt-24">
        ...
        {filteredChapters.length > 0 ? (
          ...
          <p className="mt-8 rounded-2xl border border-[#E8DDF5] bg-[#FBF8FF] p-6 text-sm text-[#4B3A61]">
            No chapters found for your search. Try a university, city, or country name.
          </p>
        )
      </Section>
      ...
      <Section id="impact" className="scroll-mt-24">
          ...
          {impactByChapter.map((item) => {
            ...
            return (
              <button
                ...
                aria-controls={`impact-panel-${item.chapterId}`}
                id={`impact-tab-${item.chapterId}`}
        ...
        <div
          className="mt-8"
          role="tabpanel"
          id={`impact-panel-${activeImpact.chapterId}`}
          aria-labelledby={`impact-tab-${activeImpact.chapterId}`}
        >
        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-3">
          ...
          <Card>
            ...
            <form className="mt-4 space-y-3" onSubmit={handleSubscribe} noValidate>
              ...
              {formMessage ? (
                <p className="text-sm text-[#4B3A61]" aria-live="polite">
                  {formMessage}
                </p>
              ) : null}
            </form>
